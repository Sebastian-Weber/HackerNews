import './App.css';
import './assets/images/react-logo.svg'
...
function App() {
  ...
  return (
	<>
		...
		{/* <div class="my-4"><img src="./src/assets/images/react-logotype.png"></img></div> */}
			<div class="my-4"><img class="py-4 pr-2 pl-6 size-full md:size-auto" src="./src/assets/images/react-logo.svg"></img></div>
			{/* <h1 class="mb-4 text-4xl font-thin leading-none tracking-tight text-gray-700 md:text-5xl lg:text-6xl dark:text-white">React|</h1> */}
