	...
	return (
		...
		<div className="p-2 bg-gray-800 sticky top-0">
			...
			<div className="flex flex-row mx-4 my-4 items-center">
				...
				{/* Heading */}
					<h1 className="pl-2 mb-4 my-4 text-4xl font-sans font-regular leading-none tracking-tight cursor-default text-gray-200 md:text-5xl lg:text-6xl dark:text-white">Hacker|</h1>
					<h1 className="mb-4 my-4 pt-2 text-4xl font-mono font-semibold leading-none tracking-tight cursor-default text-gray-200 md:text-5xl lg:text-6xl dark:text-white">News</h1>
			</div>
		{/* Header nav bar */}	
		<div className="my-2 mx-2 flex justify-between row">
			...
			<div className="flex flex-row justify-end">
				<form onSubmit={handleSubmit}>
					<div className="px-4">
						<input class="w-28 md:min-w-36 lg:min-w-44 px-1 placeholder-gray-900 focus:ring-0" type="text" placeholder="&nbsp;Search ..." ref={inputRef}/>
					</div>
				</form>
			</div>
