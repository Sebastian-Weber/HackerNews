...
function Header(props) {
	...
	return (
		...
		{/* Header nav bar */}	
		<div className="flex flex-wrap mx-2 py-4 items-start justify-between">
		...
		<div className="flex flex-row items-end justify-end">
			<form onSubmit={handleSubmit}>
				<div className="m-2">
					<input class="w-28 md:min-w-36 lg:min-w-44 px-1 placeholder-gray-900 focus:ring-1" type="text" placeholder="&nbsp;Search ..." ref={inputRef}/>
				</div>
			</form>
		</div>
		</div>
