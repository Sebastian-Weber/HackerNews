...
//  Variable for news entries
  ...
  const [menuItems] = useState([
    { name: " ReactNews | ", url: "http://hn.algolia.com/api/v1/search?query=react&tags=story" },
    { name: " | Most recent |", url: "http://hn.algolia.com/api/v1/search?tags=story" },
    { name: " | Archive ", url: "http://hn.algolia.com/api/v1/search?tags=ask_hn" }
  ]);
